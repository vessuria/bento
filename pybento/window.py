...
class Window(object):
    ...
    def focus(self):
        ...
        try:
            ...
            if pybento.config.config.getboolean("global", "center_cursor"):
                self.center_cursor()
    ...
    def set_keyboard_focus(self):
        ...
        win32gui.SetFocus(self.hWindow)

    def attach_thread_input(self):
        current_thread = ctypes.windll.kernel32.GetCurrentThreadId()
        remote_thread = ctypes.windll.user32.GetWindowThreadProcessId(self.hWindow, None)
        ctypes.windll.user32.AttachThreadInput(remote_thread, current_thread, True)
