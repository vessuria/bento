...
from pybento.notifyicon     import NotifyIcon
from pybento.hotkey         import Hotkey
from pybento.monitor        import Monitor
from pybento.window         import Window
from pybento.taskbar        import Taskbar
from pybento.utility        import Utility

import pybento.config

##KEYS
from pybento.hotkey import keys
...
class Controller(object):
    ...
    def start(self):
        ...
        self.notifyicon.show_balloon("Started pybento", "pybento")
        ...
        try:
            ...
            while message:
                ...
                if self.stop:
                    self.notifyicon.show_balloon("Stop!", "pybento")
                    break
    ...
    def cmd_toggle_taskbar_tray(self):
        self.taskbar.toggle_tray()
